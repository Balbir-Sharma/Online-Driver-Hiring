            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/balbir2.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/balbir3.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/balbir4.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/balbir5.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/balbir6.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/balbir7.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="">
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/balbir10.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/balbir11.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/balbir12.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/balbir13.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/balbir14.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="mb-4">
                        ...
                        <h1 class="text-white"><span class="text-primary">30% OFF</span> For religious places</h1>
                    </div>
                    <p class="text-white">We will provide discount  offer for handicapped person. <br>
