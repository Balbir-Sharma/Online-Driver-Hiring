...
<div class="my-5 px-4">
    ...
    <p class="text-centre-mt-3 col-lg-4 col-md-6 py-6 mb-6 px-6 pr-5" >
     <br><br> <h4> KbsDrive4u provide the best Facilities based  on your reqiurement. If you want to enjoy
        yourself or with your family in a tour within city or out of city then KbsDrive4u is best for
        you in cheap cost and you feel comfort with us.
        KbsDrive4u provide many other Facilities
        for you like hourly based services, Monthly based services, and many other services.</h4> </p>
</div>
<hr>
<br>
<div class="container">
    ...
    <div class="col-lg-4 col-md-6 mb-6 px-4">
       ...
       <img src="photos/service1.png" width="100">
       ...
       <div class="bg-white rounded shadow p-4 border-top border-4 border-dark  ">
        <div class="d-flex align-items-center mb-2">
       <img src="photos/service2.png"  width="100">
       ...
       <div class="bg-white rounded shadow p-1 border-top border-4 border-dark ">
        <div class="d-flex align-items-center mb-2">
       <img src="photos/service4.jpg" width="120">
        <h5 class="m-0 ms-3">Monthly  basis</h5>
        </div>
        <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae eaque aliquam
             iure esse labore! Sed facilis inventore impedit quidem quam.
        </p>
       </div>
        </div>
       ...
       <img src="photos/service5.jpg" width="100">
       ...
       <img src="photos/service6.jpg" width="100">
        <h5 class="m-0 ms-3">Airport</h5>
        </div>
        <p>
       ...
       <div class="bg-white rounded shadow p-3 border-top border-4 border-dark ">
        <div class="d-flex align-items-center mb-1">
       <img src="photos/service6.jpg" width="100">
        <h5 class="m-0 ms-3">Night time</h5>
        </div>
        <p>
        Sometime, most of people want to enjoy their travelling  with his/her Family
